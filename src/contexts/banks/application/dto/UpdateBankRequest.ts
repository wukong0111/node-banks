...
export interface UpdateBankBaseRequest {
	bank_id?: string;
	name?: string;
	bank_codes?: string[];
	api?: string;
...
export interface UpdateBankWithEnvironmentsRequest
	extends UpdateBankBaseRequest {
	environments: Environment[];
	configuration: BankEnvironmentConfigRequest;
}

export interface UpdateBankWithConfigurationsRequest
	extends UpdateBankBaseRequest {
...
export interface UpdateBankRequestWithId {
	bankId: string;
